...
description = u'A pythonic internationalization and localization solution for Python web applications'
...
html_use_opensearch = project_url
...
htmlhelp_basename = '{}doc'.format(module)
